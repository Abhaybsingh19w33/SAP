REPORT ZYNY_MP_ROW_COLOR_CHANGE_10.
...
DATA : CLICK_COUNTER TYPE I VALUE 0.
...
* LOOPING THROUGH DATA
    LOOP AT LT_MARA INTO LS_MARA.
      ...
      IF SY-SUBRC = 0.
         ...
         LS_CELL_COLORS-COLOR-COL = '6'.
         LS_CELL_COLORS-COLOR-INT = 1.
         LS_CELL_COLORS-COLOR-INV = 1.
         INSERT LS_CELL_COLORS INTO TABLE LT_CELL_COLORS.

         LS_CELL_COLORS-FNAME = 'ERSDA'.
         LS_CELL_COLORS-COLOR-COL = '6'.
         LS_CELL_COLORS-COLOR-INT = '0'.
         LS_CELL_COLORS-COLOR-INV = '0'.
         INSERT LS_CELL_COLORS INTO TABLE LT_CELL_COLORS.
...
FORM INC_COUNTER .
  ...
  DATA : LV_COLOR TYPE LVC_S_SCOL-COLOR-COL .

  IF CLICK_COUNTER = 0.
    CLICK_COUNTER = CLICK_COUNTER + 1.
    LV_COLOR = 1.
  ELSEIF CLICK_COUNTER = 1.
    CLICK_COUNTER = CLICK_COUNTER + 1.
    LV_COLOR = 6.
  ELSEIF CLICK_COUNTER = 2.
    CLICK_COUNTER = CLICK_COUNTER + 1.
    LV_COLOR = 3.
  ELSEIF CLICK_COUNTER = 3.
    CLICK_COUNTER = 0.
  ENDIF.
...
* LOOPING THROUGH DATA
    LOOP AT LT_MARA INTO LS_MARA.
      ...
      IF SY-SUBRC = 0.
         ...
         ELSE.
            LS_CELL_COLORS-FNAME = 'MATNR'.
            LS_CELL_COLORS-COLOR-COL = LV_COLOR.
            LS_CELL_COLORS-COLOR-INT = 1.
            LS_CELL_COLORS-COLOR-INV = 1.
            INSERT LS_CELL_COLORS INTO TABLE LT_CELL_COLORS.
