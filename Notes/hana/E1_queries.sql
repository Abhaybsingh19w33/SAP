...
insert into "TRAINEE04"."MT_18" values('1000','SAP1000','PVTLTD','SAP1000@GMAIL.COM','02-3344556','2018/01/08','X')

================================================
3)to insert multiple records
insert into "TRAINEE04"."MT_18" values('4000','SAP4000','PVTLTD','SAP4000@GMAIL.COM','02-3344556','2018/01/08','X');

insert into "TRAINEE04"."MT_18" values('5000','SAP5000','PVTLTD','SAP5000@GMAIL.COM','02-3344556','2018/01/08','');
...
case ACTIVE
 ...
 from "TRAINEE02"."KNA1_18"

================================================
6) from other schema Error select * from kna1
Corrrect : select * from SAPLS4.kna1

================================================
7)  To change the datatype of already created table use alter
alter table rt_kna1 alter(kunnr varchar(10))

alter table MT2_KNA1 alter( "Name 1" varchar(25))
