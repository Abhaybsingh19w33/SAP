		...
		return BaseController.extend("bb.b.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("bb.b.view.ViewSettingsDialog", this);
