sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("bb/b/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("bb.b.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["bb/b/localService/mockserver"], function (mockserver) {
