...
( |            arrival_time, | )
*( |            distance, | )
*distance in table /dmo/connection is of type INT4 whereas
*distance in table table_name_connection is of type dec( 12, 2)
  ...
  METHOD get_connection_table_fields.
    connection_table_fields = VALUE tt_fields(
                  ...
                  ( field         = 'distance'
                    ...
                    "/dmo/flight_distance has the wrong data type INT4
...
*   Create data generator class
    ...
    DATA(rap_bo_generator) = /dmo/cl_rap_generator=>create_for_cloud_development( json_string ).
